...
// naming convention
// cell : this is not living or dead, it's an empty cell if it exists. Its shape is an hexagon
// alive unit : it's what in original game of life it's called a living cell. here the living unit can be round or hexagon shaped
// dead unit : it's a unit used to be alive, the dead unit disappear (instantly or not, in option) and leave the cell empty
// boundaries : cells where living units cannot be set or exist
// killing cell : it's an option added by my own : if a living unit spawn in the first layer around the killing cell, that unit will die next turn
...
// setup.js generate hexagonal pattern
// transfert d'un repère vectoriel sur un plan cartésien non orthonormé
